...
class NativeToolExecutionCubit extends Cubit<NativeToolExecutionState> {
  NativeToolExecutionCubit() : super(const NativeToolExecutionState.idle());
  ...
  void _resolve(String id, bool approved) {
    ...
    emit(const NativeToolExecutionState.idle());
    _promoteNext();
  }
  ...
  void _promoteNext() {
    ...
    emit(NativeToolExecutionState(currentRequest: _queue.first));
  }
}
