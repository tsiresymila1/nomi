...
@override
String toString() {
  return 'ChatMessage(id: $id, chatId: $chatId, role: $role, content: $content, createdAt: $createdAt)';
}
...
class _ChatMessage implements ChatMessage {
  const _ChatMessage({required this.id, required this.chatId, required this.role, required this.content, required this.createdAt});
