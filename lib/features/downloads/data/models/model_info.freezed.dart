...
mixin _$ModelInfo {
 ...
 int get id; String get name; String get description; String? get modelId; String get modelType; bool get supportImage; bool get supportAudio; bool get supportsFunctionCalls; bool get isThinking; String get sourceType; String get source;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,modelId,modelType,supportImage,supportAudio,supportsFunctionCalls,isThinking,sourceType,source);

@override
String toString() {
  return 'ModelInfo(id: $id, name: $name, description: $description, modelId: $modelId, modelType: $modelType, supportImage: $supportImage, supportAudio: $supportAudio, supportsFunctionCalls: $supportsFunctionCalls, isThinking: $isThinking, sourceType: $sourceType, source: $source)';
}
...
@useResult
$Res call({
 int id, String name, String description, String? modelId, String modelType, bool supportImage, bool supportAudio, bool supportsFunctionCalls, bool isThinking, String sourceType, String source
});
...
/// Create a copy of ModelInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = null,Object? modelId = freezed,Object? modelType = null,Object? supportImage = null,Object? supportAudio = null,Object? supportsFunctionCalls = null,Object? isThinking = null,Object? sourceType = null,Object? source = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String description,  String? modelId,  String modelType,  bool supportImage,  bool supportAudio,  bool supportsFunctionCalls,  bool isThinking,  String sourceType,  String source)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ModelInfo() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.modelId,_that.modelType,_that.supportImage,_that.supportAudio,_that.supportsFunctionCalls,_that.isThinking,_that.sourceType,_that.source);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String description,  String? modelId,  String modelType,  bool supportImage,  bool supportAudio,  bool supportsFunctionCalls,  bool isThinking,  String sourceType,  String source)  $default,) {final _that = this;
switch (_that) {
case _ModelInfo():
return $default(_that.id,_that.name,_that.description,_that.modelId,_that.modelType,_that.supportImage,_that.supportAudio,_that.supportsFunctionCalls,_that.isThinking,_that.sourceType,_that.source);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String description,  String? modelId,  String modelType,  bool supportImage,  bool supportAudio,  bool supportsFunctionCalls,  bool isThinking,  String sourceType,  String source)?  $default,) {final _that = this;
switch (_that) {
case _ModelInfo() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.modelId,_that.modelType,_that.supportImage,_that.supportAudio,_that.supportsFunctionCalls,_that.isThinking,_that.sourceType,_that.source);case _:
  return null;
...
class _ModelInfo implements ModelInfo {
  const _ModelInfo({required this.id, required this.name, required this.description, this.modelId, required this.modelType, required this.supportImage, required this.supportAudio, required this.supportsFunctionCalls, required this.isThinking, required this.sourceType, required this.source});
...
/// Create a copy of ModelInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? description = null,Object? modelId = freezed,Object? modelType = null,Object? supportImage = null,Object? supportAudio = null,Object? supportsFunctionCalls = null,Object? isThinking = null,Object? sourceType = null,Object? source = null,}) {
